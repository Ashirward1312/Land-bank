...
const BANK_AUCTION_PROPERTIES = [
    {
        id: "gol-chowk-bank-auction",
        title: "BANK / AUCTION PROPERTY – NEAR GOL CHOWK",
        location: "Near Gol Chowk, Raipur",
        type: "Bank / Auction Property",
    },
    {
        id: "samta-colony-bank-auction",
        title: "BANK / AUCTION PROPERTY – NEAR SAMTA COLONY",
        location: "Near Samta Colony, Raipur",
        type: "Bank / Auction Property",
    },
];
...
function BankAuctionCard({ item, index }) {
    const { title, location, type } = item;
            ...
            <div className="border-t border-white/5 px-5 md:px-6 py-4 bg-black/70">
                <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                    <span className="text-xs text-slate-400 sm:flex-1">
                        Bank / auction properties near Gol Chowk and Samta Colony – share
                        your requirement.
                    </span>
            ...
            <div className="max-w-6xl mx-auto px-4 md:px-6">
             ...
             <button
                ...
                <header className="mb-6 space-y-3 text-center">
                    ...
                    >
                        BANK / AUCTION PROPERTIES • RAIPUR
                    </p>
                </header>
                ...
                <div className="mb-8 flex justify-center">
                    <img
                        src={img}
                        alt="Bank and auction properties in Raipur"
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    {BANK_AUCTION_PROPERTIES.map((item, index) => (
                        <BankAuctionCard key={item.id} item={item} index={index} />
                    ))}
                </div>
            </div>
        </section>
