...
export default function Services() {
  ...
  // Light Gold variant (optional) – switch to this for a paler vibe
  const LIGHT_GOLD = {
    soft: "#FFE29A",
    base: "#F7D27D",
    light: "#FFF0BD",
  ...
  // Pick which palette you want
  const BRAND = GOLD; // change to LIGHT_GOLD for a lighter look
  ...
  return (
    <main className="bg-neutral-950 text-neutral-100" id="services">
      <section className="max-w-[1200px] mx-auto px-4 md:px-6 py-12">
        ...
        {/* items-start keeps each card at its own height even when a neighbor expands */}
            ...
            return (
              <article
                ...
                className={`self-start rounded-2xl bg-neutral-900/90 ring-1 ring-white/10 p-5 transition ${
                  isOpen ? `shadow-[0_12px_30px_-12px_rgba(212,175,55,.55)]` : ""
                }`}
              >
                ...
                <div className="mt-5 flex items-center justify-between">
                  ...
                  <a
                    href="#contact"
                    className="inline-flex items-center justify-center rounded-lg px-4 py-2.5 text-sm font-semibold text-neutral-900 ring-1 transition active:scale-[.99]"
                    style={{
                      background: `linear-gradient(135deg, ${BRAND.soft}, ${BRAND.base} 70%)`,
