  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          ref={heroRef}
          className={`relative mx-auto max-w-4xl rounded-3xl p-[1.5px] transition-all duration-700 ${heroInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3"
            }`}
          style={{
            background: `linear-gradient(135deg, ${BRAND.base}CC, ${BRAND.soft}59 40%, ${BRAND.base}CC)`,
            boxShadow: `0 18px 60px -24px ${BRAND.glow}`,
          }}
        >
          <div className="rounded-[calc(1.5rem-1.5px)] bg-neutral-900 text-white ring-1 ring-white/10 p-6 sm:p-10 relative overflow-hidden">
            ...
            <div
              ...
              aria-hidden="true"
              style={{
                backgroundImage: `radial-gradient(600px 300px at 25% 15%, ${BRAND.mesh1}, transparent 60%),
                   radial-gradient(700px 320px at 85% 80%, ${BRAND.mesh2}, transparent 60%)`,
              }}
            />
            ...
            <div className="mb-4 flex justify-center">
              <span
                className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs font-medium tracking-wide heading-font ring-1 uppercase"
                style={{
                  color: "white",
                  backgroundColor: `${BRAND.soft}1A`,
                  borderColor: `${BRAND.ring}`,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-center">
              ...
              <div className="lg:col-span-5 flex justify-center lg:justify-start">
                <div className="relative">
                  <div
                    className="p-[3px] rounded-full"
                    style={{
                      background: `conic-gradient(from 180deg at 50% 50%, ${BRAND.base}D9, ${BRAND.soft}99, ${BRAND.base}D9)`,
                    }}
                  >
                    <div className="rounded-full bg-neutral-900 p-[3px]">
                      <img
              ...
              <div className="lg:col-span-7 space-y-4 text-center lg:text-left">
                <h2
                  className="heading-font text-xl sm:text-2xl lg:text-3xl font-bold leading-tight uppercase"
                  style={{ color: BRAND.base }}
                >
                  {FOUNDER.quote}
                </h2>
                ...
                <p className="paragraph-font text-neutral-200 text-sm sm:text-base lg:text-[16px] leading-relaxed max-w-lg mx-auto lg:mx-0">
                  Over Two decades in real estate strategy, sales, and marketing.
                  From large-scale builder planning to pan-India broker networks,
                  <span style={{ fontWeight: "700", color: "#F3D98E" }}>PRADEEP MAHESHWARI </span>
                    has led innovative models that accelerate closures and create long-term value.
                </p>
                ...
                {(FOUNDER.name || FOUNDER.role) && (
                  <div className="pt-1">
                    {FOUNDER.name && (
                      <div
                        className="heading-font text-sm sm:text-base font-semibold uppercase"
                        style={{ color: BRAND.base }}
                      >
                        {FOUNDER.name}
                      </div>
                    ...
                    {FOUNDER.role && (
                      <div className="paragraph-font text-xs sm:text-sm text-neutral-300 uppercase">
                        {FOUNDER.role}
                      </div>
                    )}
                  </div>
        ...
        {/* ================== Section Header ================== */}
        <div className="text-center mt-12 sm:mt-16">
          <h3 className="heading-font text-2xl sm:text-3xl font-bold text-white mb-2 inline-block uppercase">
            WHO WE ARE
            <span
              className="block w-14 h-1 rounded mt-2 mx-auto"
              style={{
                backgroundColor: BRAND.base,
                boxShadow: `0 6px 16px -8px ${BRAND.glow}`,
              }}
            />
          </h3>
          <p className="paragraph-font text-neutral-300 max-w-2xl mx-auto text-sm sm:text-base lg:text-[17px] leading-relaxed">
        ...
        <div
          ref={gridRef}
          className={`mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 transition-all duration-700 ${gridInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3"
            }`}
        >
          {features.map((f, i) => {
            const Icon = React.cloneElement(f.icon, {
            ...
            return (
              <div
                key={i}
                className={`group relative flex flex-col items-center text-center rounded-2xl p-6 ring-1 transition ${prefersReducedMotion ? "" : "hover:-translate-y-0.5"
                  }`}
                style={{
                  background: "rgba(255,255,255,0.02)",
                  borderColor: "rgba(255,255,255,0.08)",
              ...
              >
                ...
                <span
                  className="absolute top-0 left-0 right-0 h-[2px] rounded-t-2xl"
                  style={{
                    background: `linear-gradient(90deg, transparent, ${BRAND.base}B3, ${BRAND.soft}99, transparent)`,
                  }}
                />
                ...
                <h4
                  className="heading-font mt-1 text-[17px] sm:text-[18px] font-semibold uppercase"
                  style={{ color: BRAND.soft }}
                >
                  {f.title}
                </h4>
